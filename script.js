...
const removePokemon = () => {
    const pokemonEls = document.getElementByClassName("pokemon");
...
function createPokemonCard(pokemon){
    ...
    const base_value = pokemon.stats.map((el) => e.base_stat);
    ...
    <div class="infor">
    <spanclass = "number">#${pokemon.id.toString().padStar(3,"0")}</span>
